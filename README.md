...
- [UpRes Upscaler](https://github.com/auroracapital/upres-cli) - Upscale images and videos up to 8K resolution with 14 public model aliases via developer REST API and MCP server. *By [@auroracapital](https://github.com/auroracapital)*
