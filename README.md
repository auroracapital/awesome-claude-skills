...
- [UpRes Upscaler](https://github.com/auroracapital/upres.ai) - Upscale images and videos up to 8K resolution with 14 neural models via developer REST API and MCP server. *By [@auroracapital](https://github.com/auroracapital)*
